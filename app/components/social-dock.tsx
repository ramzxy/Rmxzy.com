...
const socials: Social[] = [
  {
    name: "GitHub",
    code: "gh",
    address: "github.com/ramzxy",
    href: "https://github.com/ramzxy",
    icon: <Github size={19} aria-hidden />,
  },
  {
    name: "LinkedIn",
    code: "in",
    address: "linkedin.com/in/rmxzy",
    href: "https://linkedin.com/in/rmxzy",
    icon: <Linkedin size={19} aria-hidden />,
  },
  {
    name: "Discord",
    code: "dc",
    address: "discord / rmxzy",
  ...
  },
  {
    name: "Codeforces",
    code: "cf",
    address: "codeforces / Rmsy0x",
    href: "https://codeforces.com/profile/Rmsy0x",
    icon: <CodeforcesIcon size={19} />,
  },
  {
    name: "Goodreads",
    code: "gr",
    address: "goodreads / rmxzy",
    href: "https://www.goodreads.com/user/show/192390307",
    icon: <GoodreadsIcon size={19} />,
  },
  {
    name: "Email",
    code: "@",
    address: "me@rmxzy.com",
    href: "mailto:me@rmxzy.com",
    icon: <Mail size={19} aria-hidden />,
  },
];
...
export const SocialDock = ({ className = "" }: SocialDockProps) => {
  ...
  return (
    <motion.nav
      ...
      aria-label="Find Ilia elsewhere"
    >
      <div className={styles.readout}>
        <div className={styles.readoutMeta}>
          <span><i aria-hidden /> contact relay</span>
          <span>{String(activeIndex + 1).padStart(2, "0")} / {String(socials.length).padStart(2, "0")}</span>
        </div>

        <div className={styles.destination} aria-live="polite">
          <span className={styles.destinationIcon}>{activeSocial.icon}</span>
          <span className={styles.destinationCopy}>
            <strong>{activeSocial.name}</strong>
            <small>{activeSocial.address}</small>
          </span>
          <span className={styles.destinationArrow} aria-hidden>↗</span>
        </div>
      </div>
        ...
        {socials.map((social, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="sr-only">{social.name}: {social.address}</span>
            </Link>
          );
        })}
      </div>

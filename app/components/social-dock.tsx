...
const GoodreadsIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
const socials = [
  { name: "GitHub", href: "https://github.com/ramzxy", icon: <Github size={16} aria-hidden /> },
  { name: "Email", href: "mailto:me@rmxzy.com", icon: <Mail size={16} aria-hidden /> },
  { name: "LinkedIn", href: "https://linkedin.com/in/rmxzy", icon: <Linkedin size={16} aria-hidden /> },
  { name: "Discord", href: "https://discord.com/users/rmxzy", icon: <DiscordIcon /> },
  { name: "Codeforces", href: "https://codeforces.com/profile/Rmsy0x", icon: <CodeforcesIcon /> },
  { name: "Goodreads", href: "https://www.goodreads.com/user/show/192390307", icon: <GoodreadsIcon /> },
];

export function SocialDock({ className = "" }: { className?: string }) {
  return (
    <nav className={`${styles.ribbon} ${className}`} aria-label="Find Ilia elsewhere">
